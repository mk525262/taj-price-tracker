...
URL = "https://www.tajhotels.com/en-in/bookings/landing-page?hotelId=d21c3bf6-f508-47ae-a456-540429b02b0d&adults=1&children=0&from=2026-12-25&to=2026-12-26"
...
def select_dates(page):
    ...
    # CLOUD FIX:
    # Taj supports booking dates in the URL. In headless GitHub Actions the
    # visual calendar may not open reliably, so first verify whether the
    # requested dates are already present after navigation.
    try:
        page.wait_for_timeout(1500)
        body_text = page.locator("body").inner_text()
        normalized = " ".join(body_text.split()).lower()
        if (
            "25 dec 2026" in normalized
            and "26 dec 2026" in normalized
        ):
            print("Cloud URL se 25 Dec 2026 -> 26 Dec 2026 already selected.")
            return True
    except Exception as e:
        print("Cloud URL date verification:", e)
